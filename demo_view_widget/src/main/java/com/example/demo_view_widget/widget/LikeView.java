package com.example.demo_view_widget.widget;
...
import com.example.demo_view_widget.R;
import com.example.demo_view_widget.ui.home.MyClickListener;
...
public class LikeView extends RelativeLayout {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (interval < INTERVAL) {//小于1秒，拦截事件，并做处理
                    ...
                    //设置图片资源
                    imageView.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.ic_heart));
    ...
    public MyClickListener getOnClickListener() {
